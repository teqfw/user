...
const srcTeqFwUser = join(pathNode, '@teqfw/user/src');
...
container.addSourceMapping('TeqFw_User', srcTeqFwUser, true, 'mjs');
// setup replacements
container.addModuleReplacement('TeqFw_Db_Back_Api_RDb_Schema', 'TeqFw_Db_Back_RDb_Schema');
